        ...
        <div className="max-w-7xl mx-auto px-4">
          <ul className="flex items-center gap-1 overflow-x-auto scrollbar-hide py-2">
            ...
            <li>
              <Link
                href="/ofertas"
                className="ml-1 block px-3 py-1.5 text-sm font-bold text-white bg-gradient-to-r from-purple-600 to-cyan-400 rounded-md hover:opacity-90 transition whitespace-nowrap"
              >
                Ofertas 🔥
              </Link>
            </li>
